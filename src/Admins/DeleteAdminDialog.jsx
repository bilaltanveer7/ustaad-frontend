  ...
  return (
    ...
    >
      ...
      <DialogContent>
        ...
        <Box sx={{ mt: 2, p: 2, backgroundColor: '#fff3cd', borderRadius: '8px', border: '1px solid #ffeaa7' }}>
          <Typography variant="body2" sx={{ color: '#856404', fontWeight: 500 }}>
            ⚠️ Warning: This action cannot be undone. The admin will lose access to the system immediately.
          </Typography>
        </Box>
      </DialogContent>
